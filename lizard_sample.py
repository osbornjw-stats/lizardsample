...
st.markdown("""
Welcome to the field simulation. Your goal is to estimate the true average weight 
of the lizard population on this island. 
**Configure your sampling strategy in the sidebar.**
""")
